...
def Find_epipoles(F_mat,line1_dash,line2_dash,line1,line2):
    ...
    cv2.circle(img1, (int(a[0]),int(a[1])), 4,  (0,0,255), 1)
    cv2.circle(img2, (int(b[0]),int(b[1])), 4,  (0,0,255), 1)
    ...
    cv2.circle(img1, (int(temp[0]),int(temp[1])), 4,  (0,0,255), 1)
    ...
    cv2.circle(img2, (int(temp[0]),int(temp[1])), 4,  (0,0,255), 1)
